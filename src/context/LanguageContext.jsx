...
const translations = {
    id: {
        ...
        heroDesc: "Saya membantu mengubah ide menjadi produk web, mobile, dan Web3 yang benar-benar dipakai orang — dari sketsa awal sampai aplikasi siap rilis. Buat saya, kode yang baik adalah yang menyelesaikan masalah nyata, bukan sekadar berjalan.",
    ...
    en: {
        ...
        heroDesc: "I help turn ideas into web, mobile, and Web3 products that people genuinely use — from first sketch to launch-ready app. To me, good code is code that solves a real problem, not just code that runs.",
